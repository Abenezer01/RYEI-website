...
import { IMPACT_STATS, PROGRAMS, MISSION_STATEMENT } from '../constants';
    ...
    <div className="overflow-hidden font-sans">
      ...
      <SectionWrapper background="light">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16">
          ...
          <Link to="/programs" className="hidden md:flex items-center text-navy font-bold hover:text-primary transition-colors mt-4 md:mt-0 group">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {PROGRAMS.slice(0, 3).map((prog, idx) => {
             ...
             return (
              <Link to="/programs" key={prog.id} className="group">
        ...
        <div className="mt-10 text-center md:hidden">
           <Link to="/programs" className="inline-flex items-center text-navy font-bold hover:text-primary transition-colors">
      ...
      <SectionWrapper background="white">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
                ...
                <div className="mt-10">
                     <Link to="/about" className="text-navy font-bold border-b-2 border-primary hover:text-primary transition-colors pb-1">
