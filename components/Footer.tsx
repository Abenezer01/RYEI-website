        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li><Link to="/" className="text-gray-300 hover:text-primary transition-colors inline-block">Home</Link></li>
              <li><Link to="/about" className="text-gray-300 hover:text-primary transition-colors inline-block">About Us</Link></li>
              <li><Link to="/programs" className="text-gray-300 hover:text-primary transition-colors inline-block">Our Programs</Link></li>
              <li><Link to="/contact" className="text-gray-300 hover:text-primary transition-colors inline-block">Contact</Link></li>
            </ul>
          </div>
          ...
          <div>
             ...
             <ul className="space-y-3 text-sm">
              <li><Link to="/contact" className="text-gray-300 hover:text-primary transition-colors">Partner With Us</Link></li>
              <li><Link to="/contact" className="text-gray-300 hover:text-primary transition-colors">Volunteer</Link></li>
              <li><Link to="/contact" className="text-gray-300 hover:text-primary transition-colors">Donate</Link></li>
             </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              ...
              <li className="flex items-center space-x-3">
                ...
                <span className="text-gray-300">info@ryei.org</span>
              </li>
              <li className="flex items-center space-x-3">
